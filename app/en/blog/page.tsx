...
export const metadata = {
  title: 'Blog - WebCraft Media',
  description: 'Practical content for small businesses: AI, automation, SEO, GEO, reviews, WhatsApp, and local growth.',
}
        ...
        <div className="section-padding max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-400 text-lg max-w-2xl mx-auto">
              Practical content for small businesses — AI, automation, SEO, GEO, reviews, WhatsApp, and local growth.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {blogPosts.map((post) => (
              ...
              >
                ...
                <p className="text-sm text-gray-400 mb-4">{post.excerpt.en}</p>
