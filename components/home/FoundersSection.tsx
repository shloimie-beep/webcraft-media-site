      ...
      <div className="section-padding max-w-7xl mx-auto">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            WebCraft Media נוסדה כדי לעזור לעסקים קטנים לנצל את כוח האוטומציה המודרנית בלי המורכבות שבדרך כלל מגיעה איתה.
          </p>
        </AnimatedSection>
            ...
            >
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-brand-teal">{f.role.he}</p>
                </div>
              </div>
              <p className="text-gray-400 text-sm leading-relaxed">{f.bio.he}</p>
            </motion.div>
          ))}
        </div>
        ...
        <motion.div 
          ...
          transition={{ duration: 0.6 }}
        >
          <h3 className="text-2xl font-bold text-white mb-4">המשימה שלנו</h3>
          <p className="text-gray-400 max-w-2xl mx-auto">
            המטרה של WebCraft Media פשוטה: לעזור לעסקים לענות מהר יותר, לעבוד בצורה חכמה יותר, ולצמוח בביטחון באמצעות שילוב נכון של אוטומציה, AI ומערכות web מודרניות.
          </p>
